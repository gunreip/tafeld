...
\restrict PKCJCI97M4qTOOVCeoX9OgzWgYcWKJofFLCZ0hz5JtdYHzJRB4nsahBGU4PSvyY
...
--
-- Name: cashbook_entries cashbook_entries_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--

ALTER TABLE ONLY public.cashbook_entries
    ADD CONSTRAINT cashbook_entries_uuid_unique UNIQUE (uuid);
...
--
-- Name: customers customers_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--
...
--
-- Name: documents documents_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--
...
--
-- Name: employees employees_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--
...
--
-- Name: inventory_items inventory_items_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--
...
--
-- Name: stock_movements stock_movements_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--
...
--
-- Name: vehicles vehicles_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--

ALTER TABLE ONLY public.vehicles
    ADD CONSTRAINT vehicles_uuid_unique UNIQUE (uuid);
...
--
-- Name: work_schedules work_schedules_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: gunreip
--

ALTER TABLE ONLY public.work_schedules
    ADD CONSTRAINT work_schedules_uuid_unique UNIQUE (uuid);
...
--
-- Name: documents documents_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: gunreip
--
...
\unrestrict PKCJCI97M4qTOOVCeoX9OgzWgYcWKJofFLCZ0hz5JtdYHzJRB4nsahBGU4PSvyY
